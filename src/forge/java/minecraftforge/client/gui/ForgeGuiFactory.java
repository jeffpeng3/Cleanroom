...
package minecraftforge.client.gui;
...
import minecraftforge.common.ForgeChunkManager;
...
import minecraftforge.fml.client.config.GuiConfigEntries.CategoryEntry;
...
import minecraftforge.fml.client.config.GuiConfigEntries.BooleanEntry;
...
public class ForgeGuiFactory implements IModGuiFactory
{
    ...
    public static class ForgeConfigGui extends GuiConfig
    {
        ...
        public static class VersionCheckEntry extends CategoryEntry
        {
            ...
            protected GuiScreen buildChildScreen()
            {
                ConfigCategory cfg = ForgeModContainer.getConfig().getCategory(ForgeModContainer.VERSION_CHECK_CAT);
                ...
                for (ModContainer mod : ForgeVersion.gatherMods().keySet())
                {
                    ...
                    props.add(ForgeModContainer.getConfig().get(ForgeModContainer.VERSION_CHECK_CAT, mod.getModId(), true)); //Get or make the value in the config
                }
                ...
                return new GuiConfig(this.owningScreen,
                                     list,
                                     this.owningScreen.modID, ForgeModContainer.VERSION_CHECK_CAT, true, true,
                                     GuiConfig.getAbridgedConfigPath(ForgeModContainer.getConfig().toString()));
            }
        }

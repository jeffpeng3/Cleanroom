...
package minecraftforge.fml.client;
...
import minecraftforge.client.CloudRenderer;
import minecraftforge.client.IRenderHandler;
import minecraftforge.client.event.ModelRegistryEvent;
import minecraftforge.client.resource.IResourceType;
import minecraftforge.client.resource.ReloadRequirements;
import minecraftforge.client.resource.SelectiveReloadStateHandler;
import minecraftforge.common.MinecraftForge;
import minecraftforge.common.config.ConfigManager;
import minecraftforge.common.util.CompoundDataFixer;
import minecraftforge.fml.client.registry.RenderingRegistry;
import minecraftforge.fml.common.DummyModContainer;
import minecraftforge.fml.common.DuplicateModsFoundException;
import minecraftforge.fml.common.FMLCommonHandler;
import minecraftforge.fml.common.FMLContainerHolder;
import minecraftforge.fml.common.FMLLog;
import minecraftforge.fml.common.IFMLSidedHandler;
import minecraftforge.fml.common.Loader;
import minecraftforge.fml.common.LoaderException;
import minecraftforge.fml.common.MetadataCollection;
import minecraftforge.fml.common.MissingModsException;
import minecraftforge.fml.common.ModContainer;
import minecraftforge.fml.common.ModMetadata;
import minecraftforge.fml.common.MultipleModsErrored;
import minecraftforge.fml.common.ObfuscationReflectionHelper;
import minecraftforge.fml.common.StartupQuery;
import minecraftforge.fml.common.WrongMinecraftVersionException;
import minecraftforge.fml.common.eventhandler.EventBus;
import minecraftforge.fml.common.network.FMLNetworkEvent;
import minecraftforge.fml.common.network.internal.FMLNetworkHandler;
import minecraftforge.fml.common.toposort.ModSortingException;
...
public class FMLClientHandler implements IFMLSidedHandler
{
    ...
    public void beginMinecraftLoading(Minecraft minecraft, List<IResourcePack> resourcePackList, IReloadableResourceManager resourceManager, MetadataSerializer metaSerializer)
    {
        ...
        catch (WrongMinecraftVersionException |
               DuplicateModsFoundException | MissingModsException |
               ModSortingException | CustomModLoadingErrorDisplayException |
               MultipleModsErrored e)
        {

...
package minecraftforge.fml.client.config;

import static minecraftforge.fml.client.config.GuiUtils.RESET_CHAR;
import static minecraftforge.fml.client.config.GuiUtils.UNDO_CHAR;
...
import minecraftforge.fml.client.event.ConfigChangedEvent;
import minecraftforge.fml.client.event.ConfigChangedEvent.OnConfigChangedEvent;
import minecraftforge.fml.client.event.ConfigChangedEvent.PostConfigChangedEvent;

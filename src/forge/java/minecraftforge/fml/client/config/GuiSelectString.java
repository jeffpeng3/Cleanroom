...
public class GuiSelectString extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        int undoGlyphWidth = mc.fontRenderer.getStringWidth(GuiUtils.UNDO_CHAR) * 2;
        int resetGlyphWidth = mc.fontRenderer.getStringWidth(GuiUtils.RESET_CHAR) * 2;
        ...
        this.buttonList.add(btnDefault = new GuiUnicodeGlyphButton(2001, this.width / 2 - buttonWidthHalf + doneWidth + 5 + undoWidth + 5,
                                                                   this.height - 29, resetWidth, 20, " " + I18n.format("fml.configgui.tooltip.resetToDefault"), GuiUtils.RESET_CHAR, 2.0F));
        this.buttonList.add(btnUndoChanges = new GuiUnicodeGlyphButton(2002, this.width / 2 - buttonWidthHalf + doneWidth + 5,
                                                                       this.height - 29, undoWidth, 20, " " + I18n.format("fml.configgui.tooltip.undoChanges"), GuiUtils.UNDO_CHAR, 2.0F));
    }

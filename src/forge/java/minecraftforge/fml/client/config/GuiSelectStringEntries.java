...
public class GuiSelectStringEntries extends GuiListExtended
{
    ...
    public void saveChanges()
    {
        if (owningScreen.slotIndex != -1 && owningScreen.parentScreen != null
                ...
                && ((GuiConfig) owningScreen.parentScreen).entryList.getListEntry(owningScreen.slotIndex) instanceof GuiConfigEntries.SelectValueEntry)
        {
            GuiConfigEntries.SelectValueEntry entry = (GuiConfigEntries.SelectValueEntry) ((GuiConfig) owningScreen.parentScreen).entryList.getListEntry(owningScreen.slotIndex);

...
import minecraftforge.fml.common.network.NetworkCheckHandler;
...
public @interface Mod
{
     ...
     * <li> {@link FMLInterModComms.IMCEvent} : Sent just after {@link FMLInitializationEvent} if you have IMC messages waiting
     * from other mods</li>
     * </ul>
     *
     * @author cpw
    ...
    /**
     * A class which will be subscribed to {@link MinecraftForge.EVENT_BUS} at mod construction time.
     */
    @Retention(RetentionPolicy.RUNTIME)
    @Target(ElementType.TYPE)

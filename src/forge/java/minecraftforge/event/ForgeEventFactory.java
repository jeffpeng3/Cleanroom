...
import minecraftforge.client.event.ClientChatEvent;
import minecraftforge.client.event.ClientChatReceivedEvent;
import minecraftforge.client.event.RenderBlockOverlayEvent;
import minecraftforge.common.MinecraftForge;
import minecraftforge.common.capabilities.CapabilityDispatcher;
import minecraftforge.common.capabilities.ICapabilityProvider;
import minecraftforge.common.util.BlockSnapshot;
import minecraftforge.event.brewing.PlayerBrewedPotionEvent;
import minecraftforge.event.brewing.PotionBrewEvent;
import minecraftforge.event.enchanting.EnchantmentLevelSetEvent;
import minecraftforge.event.entity.EntityEvent;
import minecraftforge.event.entity.EntityMobGriefingEvent;
import minecraftforge.event.entity.EntityMountEvent;
import minecraftforge.event.entity.EntityStruckByLightningEvent;
import minecraftforge.event.entity.PlaySoundAtEntityEvent;
import minecraftforge.event.entity.ProjectileImpactEvent;
import minecraftforge.event.entity.ThrowableImpactEvent;
import minecraftforge.event.entity.item.ItemExpireEvent;
import minecraftforge.event.entity.living.AnimalTameEvent;
import minecraftforge.event.entity.living.LivingDestroyBlockEvent;
import minecraftforge.event.entity.living.LivingEntityUseItemEvent;
import minecraftforge.event.entity.living.LivingExperienceDropEvent;
import minecraftforge.event.entity.living.LivingHealEvent;
import minecraftforge.event.entity.living.LivingPackSizeEvent;
import minecraftforge.event.entity.living.LivingSpawnEvent;
import minecraftforge.event.entity.living.ZombieEvent;
import minecraftforge.event.entity.player.ArrowLooseEvent;
import minecraftforge.event.entity.player.ArrowNockEvent;
import minecraftforge.event.entity.player.BonemealEvent;
import minecraftforge.event.entity.player.EntityItemPickupEvent;
import minecraftforge.event.entity.player.FillBucketEvent;
import minecraftforge.event.entity.player.ItemTooltipEvent;
import minecraftforge.event.entity.player.PlayerDestroyItemEvent;
import minecraftforge.event.entity.player.PlayerDropsEvent;
import minecraftforge.event.entity.player.PlayerEvent;
import minecraftforge.event.entity.player.PlayerFlyableFallEvent;
import minecraftforge.event.entity.player.PlayerSetSpawnEvent;
import minecraftforge.event.entity.player.PlayerSleepInBedEvent;
import minecraftforge.event.entity.player.PlayerWakeUpEvent;
import minecraftforge.event.entity.player.SleepingLocationCheckEvent;
import minecraftforge.event.entity.player.SleepingTimeCheckEvent;
import minecraftforge.event.entity.player.UseHoeEvent;
import minecraftforge.event.furnace.FurnaceFuelBurnTimeEvent;
import minecraftforge.event.terraingen.ChunkGeneratorEvent;
import minecraftforge.event.terraingen.PopulateChunkEvent;
import minecraftforge.event.village.MerchantTradeOffersEvent;
import minecraftforge.event.world.BlockEvent;
import minecraftforge.event.world.ExplosionEvent;
import minecraftforge.event.world.GetCollisionBoxesEvent;
...
import minecraftforge.fml.common.eventhandler.Event.Result;
...
public class ForgeEventFactory
{
    ...
    {
        return renderBlockOverlay(player, renderPartialTicks, RenderBlockOverlayEvent.OverlayType.FIRE, Blocks.FIRE.getDefaultState(), new BlockPos(player));
    }

    public static boolean renderWaterOverlay(EntityPlayer player, float renderPartialTicks)
    {
        return renderBlockOverlay(player, renderPartialTicks, RenderBlockOverlayEvent.OverlayType.WATER, Blocks.WATER.getDefaultState(), new BlockPos(player));
    }
